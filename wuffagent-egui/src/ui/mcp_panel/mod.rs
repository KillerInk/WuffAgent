...
use wuffagent_core::tools::mcp::{McpManager, McpServerStatus};

use super::theme::Theme;
use edit_state::ServerEditState;
        ...
        egui::Window::new(title)
            ...
            .show(ui.ctx(), |ui| {
                ...
                ui.horizontal(|ui| {
                    ...
                    if ui
                        .selectable_label(
                            edit.transport_kind == edit_state::TransportKind::Stdio,
                            "Stdio (child process)",
                        )
                        .clicked()
                    {
                    ...
                    if ui
                        .selectable_label(
                            edit.transport_kind == edit_state::TransportKind::Http,
                            "HTTP (Streamable)",
                        )
                        .clicked()
                    {
                ...
                if edit.transport_kind == edit_state::TransportKind::Stdio {
                    ui.horizontal(|ui| {
                        ui.label("Command:");
