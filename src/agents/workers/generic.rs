...
impl WorkerAgent for ExecutingWorker {
...
impl Agent for ExecutingWorker {
...
impl ExecutingWorker {
    ...
    fn determine_tool(&self, task: &Task) -> String {
        // Try to get tool name from task input
...
fn build_tool_params(task: &Task, context: &serde_json::Value) -> ToolParams {
    ...
    // Add parent outputs from context
